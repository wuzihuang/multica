...
function createComponents(
  ...
  const baseComponents: Partial<Components> = {
    ...
    a: ({ href, children }) => {
      // Mention links: member|agent|squad|issue|project|document|notion|all
      if (href?.startsWith('mention://')) {
        const mentionMatch = href.match(/^mention:\/\/(member|agent|squad|issue|project|document|notion|all)\/(.+)$/)
